...
export ZSH="/Users/cassio/.oh-my-zsh"
...
plugins=(git zsh-interactive-cd terraform kubectl aws history-substring-search)
...
autoload -z compinit bashcompinit && compinit && bashcompinit
